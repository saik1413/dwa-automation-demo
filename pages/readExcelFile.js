...
const readExcelAndReturnData = async (filePath) => {
	const workbook = new Excel.Workbook();
	await workbook.xlsx.readFile(filePath); // Replace with your Excel file path
	const worksheet = workbook.getWorksheet("demo data"); // Replace with your sheet name
...
export { readExcelFile, readExcelAndReturnData };
